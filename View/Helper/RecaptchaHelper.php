...
class RecaptchaHelper extends AppHelper {
    ...
    public function display($options = array()) {
        $defaults = array(
            'errorInput' => '',
            'element' => null,
            'publicKey' => Configure::read('MaxAuth.Recaptcha.publicKey'),
            'error' => null,
            'ssl' => true,
            'error' => false,
            'div' => array(
    ...
    public function mailHideUrl($email = null) {
        $publicKey = Configure::read('MaxAuth.Recaptcha.mailHide.publicKey');
        $privateKey = Configure::read('MaxAuth.Recaptcha.mailHide.privateKey');
